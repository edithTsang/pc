  ...
  <div>
    ...
    <div class="sender">
      <div align="left" style="margin-bottom: 20px">
        <el-button type="warning" icon="el-icon-plus" @click="handleCreate">新增发件人地址</el-button>
      </div>
      <div class="table">
...
export default {
  ...
  methods: {
    ...
    // handleUpdate(row) {
    //   this.getTemplateDrop()
    //   this.setOptions()
    //   this.textMap.update = true
    //   this.textMap.create = false
    //   this.fromDisabled = false
    //   this.title = this.$t('edTable.request') + this.$t('table.edit')
    //   this.temp = Object.assign({}, row)
    //   this.temp.expect_entry_date = parseTime(this.temp.expect_entry_date)
    //   this.temp.card_canteen_scene = []
    //   const arr = JSON.parse(row.card_canteen_scene)
    //   for (const i in arr) {
    //     for (const y in arr[i].id) {
    //       this.temp.card_canteen_scene.push([arr[i].canteen_id, arr[i].id[y]])
    //     }
    //   }
    //   this.drawer = true
    //   this.$nextTick(() => {
