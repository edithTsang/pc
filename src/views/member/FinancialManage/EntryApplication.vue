  ...
  <div>
    ...
    <div class="entry-application">
      <div class="money">
        ...
        <div class="recharge" @click="recharge">入账申请</div>
      </div>
      <div class="search">
        <el-row>
          <el-col :span="22">
      ...
      <div class="table">
        <el-table ref="multipleTable" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%" :header-cell-style="tableHeaderStyle">
          ...
          <el-table-column prop="bankNumber" label="入账方式" show-overflow-tooltip align="center" />
          <el-table-column prop="bankNumber" label="入账金额" show-overflow-tooltip align="center" />
          <el-table-column prop="bankNumber" label="状态" show-overflow-tooltip align="center" />
          <el-table-column prop="bankNumber" label="备注" show-overflow-tooltip align="center" />
          <el-table-column prop="bankNumber" label="添加时间" show-overflow-tooltip align="center" />
          <el-table-column prop="bankNumber" label="操作" show-overflow-tooltip align="center" />
        </el-table>
